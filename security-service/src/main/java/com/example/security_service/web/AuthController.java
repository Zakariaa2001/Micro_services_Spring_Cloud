...
public class AuthController {
   ...
   // basics authentification  using Authentication authentication as param

   /* @PostMapping("/token")// for login and get jwt token
   ...
   // for login and get jwt token without refresh token
   /* @PostMapping("/token")
